...
class CheXagent(BaseLM):
    def __init__(self, checkpoint="StanfordAIMI/CheXagent-2-3b", name=f"CheXagent", device="cuda", dtype=torch.bfloat16):
        super().__init__(checkpoint=checkpoint, name=name, device=device, dtype=dtype)
